...
bool callback(ball_chaser::DriveToTarget::Request& request, ball_chaser::DriveToTarget::Response& response)
{
    ...
    //ROS_INFO("[Drive_bot]request: x=%f, z=%f", request.linear_x, request.angular_z);
    return true;
}
